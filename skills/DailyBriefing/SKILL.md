...
|-----|-----------|---------|----------------|
| **PAI Bot** | Two-way | General AI assistant, all PAI interactions | `~/.claude/settings.json` |
...
1. **Create Dedicated Briefing Bot:**
   ...
   - **Important:** This is a SEPARATE bot from your main PAI assistant bot
...
4. **Test:**
   ...
   - Verify message arrives in the briefing bot chat, NOT your PAI chat
