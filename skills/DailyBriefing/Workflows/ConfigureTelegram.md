...
|-----|---------|-----------------|
| **PAI Bot** | General AI assistant (two-way) | `~/.claude/settings.json` |
...
7. **Important:** This should be a SEPARATE bot from your PAI assistant bot
...
**Verify:** Message should arrive in your **DailyBriefing bot chat**, NOT your PAI chat.
